...
pcx_snitch_help[] = {
        ...
        "\n"
        "Dedo duro é um jogo de cartas de semi-colaboração e blefe.\n"
        "\n"
        "Vocês são todos criminosos que estão trabalhando juntos para realizar um assalto. "
        "Há 8 rodadas e em cada rodada há um líder da gangue.\n"
        "\n"
        "<b>O contrato</b>\n"
        "\n"
        "O líder da gangue escolhe quantos especialistas para o assalto e "
        "ao fazer isso, também escolhe o nível de dificuldade. Eles então levam "
        "um montante de cartas do baralho e as mostra a todos. Essas cartas "
        "formam o contrato para o assalto. Para que seja um sucesso, cada um dos "
        "especialistas deverão participar.\n"
        "\n"
        "<b>A discussão e o assalto</b>\n"
        "\n"
        "Agora é hora da fase de discussão. Todo mundo tem 10 cartas em "
        "sua mão. 7 delas representam especialistas. Você precisará trabalhar "
        "em colabaração para tentar obter as cartas necessárias para o assalto. Finalmente quando "
        "todo mundo escolher sua carta, todas são reveladas ao mesmo "
        "tempo. Se você conseguir mostrar todos os cartões necessários para o contrato, "
        "todos ganham o mesmo número de moedas que o tamanho do contrato.\n"
        "\n"
        "<b>Os dedos duros</b>\n"
        "\n"
        "No entanto, na mão de todos, há também 3 informantes. Se o assalto "
        "falha e pelo menos uma pessoa escolheu o cartão de dedo duro, em vez de "
        "tirar dinheiro do banco, os delatores roubam dinheiro dos outros "
        "jogadores! Todo mundo que não dedurou perde uma moeda e o saque é "
