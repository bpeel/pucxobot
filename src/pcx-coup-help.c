...
pcx_coup_help[] = {
        ...
        "ĝin.\n"
        "\n"
        "Antaŭ ol komenci la ludon vi povas decidi ĉu anstataŭigi la "
        "ambasadoron per la inspektisto por ludi alternativan version. La "
        "inspektisto povas interŝanĝi karton kaj bloki ŝteladon kiel la "
        "ambasadoro. Li ankaŭ povas:\n"
        "\n"
