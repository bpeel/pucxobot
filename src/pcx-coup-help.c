...
pcx_coup_help[] = {
        ...
        "\n"
        "Before starting the game you can decide whether to replace the "
        "ambassador with the inquisitor to play an alternate version of the "
        "game. The inquisitor can exchange a card and block stealing like the "
        "ambassador. He can also:\n"
        "\n"
